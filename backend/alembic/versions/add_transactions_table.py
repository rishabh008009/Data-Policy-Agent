...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("from_bank", sa.String(100), nullable=False),
        sa.Column("from_account", sa.String(100), nullable=False),
        sa.Column("to_bank", sa.String(100), nullable=False),
        sa.Column("to_account", sa.String(100), nullable=False),
        ...
        sa.Column("receiving_currency", sa.String(10), nullable=False),
        sa.Column("payment_format", sa.String(50), nullable=False),
